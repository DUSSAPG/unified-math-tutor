...
String discoveryCategoryLabel(AppLocalizations l10n, DiscoveryCategory category) {
  return switch (category) {
    ...
    DiscoveryCategory.truckingLogistics => l10n.mathStudioCategoryTruckingLogistics,
...
String discoveryDifficultyLabel(AppLocalizations l10n, CardDifficulty difficulty) {
