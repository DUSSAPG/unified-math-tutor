...
void main() {
  ...
  group('greetingPeriodFor', () {
    test('buckets hours into the right period', () {
      ...
      expect(greetingPeriodFor(DateTime(2026, 1, 1, 5)), GreetingPeriod.morning);
      expect(greetingPeriodFor(DateTime(2026, 1, 1, 11)), GreetingPeriod.morning);
      expect(
          greetingPeriodFor(DateTime(2026, 1, 1, 12)), GreetingPeriod.afternoon);
      expect(
          greetingPeriodFor(DateTime(2026, 1, 1, 17)), GreetingPeriod.afternoon);
      expect(greetingPeriodFor(DateTime(2026, 1, 1, 18)), GreetingPeriod.evening);
      expect(greetingPeriodFor(DateTime(2026, 1, 1, 22)), GreetingPeriod.evening);
  ...
  group('greetingFor', () {
    ...
    test('includes the preferred display name when set, per period', () {
      expect(
          greetingFor(l10n, GreetingPeriod.morning, 'Sam'), 'Good morning, Sam');
      expect(greetingFor(l10n, GreetingPeriod.afternoon, 'Sam'),
          'Good afternoon, Sam');
      expect(
          greetingFor(l10n, GreetingPeriod.evening, 'Sam'), 'Good evening, Sam');
      expect(
