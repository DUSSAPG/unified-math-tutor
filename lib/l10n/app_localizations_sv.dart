...
class AppLocalizationsSv extends AppLocalizations {
  ...
  String get settingsParentToolsRewards =>
      'Föräldraverktyg och belöningsanimationer';

  @override
  String get enableParentTools => 'Aktivera föräldraverktyg';

  @override
  String get parentToolsLocalOnly =>
      'Tillåt lokala verktyg för föräldrar och lärare';

  @override
  String get unlockParentTools => 'Lås upp föräldraverktyg';

  @override
  String get parentToolsPinPrompt =>
      'Skapa eller ange den lokala fyrsiffriga PIN-koden';

  @override
  String get parentTeacherTools => 'Verktyg för föräldrar och lärare';
